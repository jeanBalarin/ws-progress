 ...
 /*------------------------------------------------------------------------
    File        : webServiceRestHandler
    Purpose     : 
    Syntax      : 
    Description : 
    Author(s)   : franc
    Created     : Thu Nov 30 20:38:06 BRT 2023
    Notes       : 
  ----------------------------------------------------------------------*/
...
CLASS webServiceRestHandler INHERITS WebHandler: 
 	...
 	METHOD OVERRIDE PROTECTED INTEGER HandleGet( INPUT poRequest AS OpenEdge.Web.IWebRequest ):
        ...
        ASSIGN 
            oBody = NEW OpenEdge.Core.String(
                             'Hello franc'
                           + '~r~n':u   /*CRLF */
                           + 'This message was returned by HandleGet in webServiceRestHandler.'
                           ).
